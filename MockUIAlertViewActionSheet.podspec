Pod::Spec.new do |s|
  ...
  s.source   = { :git => 'https://github.com/jonreid/MockUIAlertViewActionSheet.git', :tag => 'v1.1.0' }
  s.source_files = 'Source/MockUIAlertViewActionSheet/*.{h,m}'
  s.public_header_files = 'Source/MockUIAlertViewActionSheet/QCOMockAlertViewVerifier.h', 'Source/MockUIAlertViewActionSheet/QCOMockActionSheetVerifier.h'
  s.requires_arc = true
end